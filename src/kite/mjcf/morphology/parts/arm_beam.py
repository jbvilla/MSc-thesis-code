...
class MJCFBKiteArmBeam(MJCFMorphologyPart):
    def __init__(
            self,
        ...
        """
        Initialize the super class of the MJCFBKiteArmBeam
        :param parent: parent morphology
        :param name: name of the MJCFBKiteArmBeam
    ...
    def _build(self, arm_index) -> None:
        self._arm_index = arm_index
        self._beam_specification = self.morphology_specification.arm_beams_specification[self._arm_index]
        self._build_beam()
